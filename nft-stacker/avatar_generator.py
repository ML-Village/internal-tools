...
class AvatarGenerator:
    ...
    def save_image_path(self, image: Image.Image, image_path: str):
    ...
    def generate_custom_avatar(self, image_path_sequence: List[str], image_path: str):
        image = self.render_custom_avatar_image(image_path_sequence)
        self.save_image_path(image, image_path)